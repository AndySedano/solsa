...
<t:layout seccion="admin" activo ="cliente_modificacion">
    <jsp:attribute name="titulo">
        Modificaciön de Personal de Ventas
    </jsp:attribute>
    <jsp:body>
        <h2>Modificación de Personal de Ventas</h2>
        ...
        <form class="form-horizontal" method="post" action="Cliente_Modificar?${venta.username}">
