...
<t:layout seccion="admin" activo ="aprobador_alta">
    <jsp:attribute name="titulo">
        Alta de Aprobadores
    </jsp:attribute>
    <jsp:body>  
        <h2>Alta de Aprobadores</h2>
        ...
        <form class="form-horizontal" method="post" action="Aprobador_Alta">
            ...
            <div class="form-group">
                <label for="idEmpresa" class="col-md-3 control-label">Empresa</label>
                <div class="col-md-9">
                    <select class="form-control" id="idEmpresa" name="idEmpresa" data-placeholder="Selecciona una empresa">
                        <option></option>
